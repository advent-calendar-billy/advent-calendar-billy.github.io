...
const NODES = [
  ...
  { id:'a_filltub', x:3, y:2, c:'tub', t:'act', label:'Fede llena la bañera', sub:'se lo pedís, sin decir para qué', deps:['plug','a_getprep'],
    idea:'Con la PrEP en la mano, le pedís a Fede que llene la bañera. NO decís que querés bañarte ni para qué — solo le pedís que la llene. Con el tapón (del ajedrez) puesto, arranca la secuencia de la bañera. (Adiós flor de la felicidad: la retiramos — nada de perder para ganar.)',
    todo:'GATILLO (vos, en vivo): al recibir la PrEP le pedís que llene la bañera, sin explicar para qué. Vos manejás el timing.' },
