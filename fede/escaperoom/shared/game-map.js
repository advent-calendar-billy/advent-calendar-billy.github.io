...
const NODES = [
  ...
  { id:'a_askfill', x:2, y:1, c:'tub', t:'act', label:'Pedís llenar la bañera', sub:'sin decir para qué', deps:['a_getprep'],
  ...
  { id:'a_filltub', x:3, y:2, c:'tub', t:'act', label:'Fede llena la bañera', sub:'busca el tapón si falta', deps:['a_askfill','plug'],
  ...
  { id:'iou', x:0, y:8, c:'misc', t:'thing', label:'IOU de 400K', sub:'decorativo · flavor',
