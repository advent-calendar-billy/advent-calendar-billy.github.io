...
const NODES = [
  ...
  { id:'a_filltub', x:3, y:2, c:'tub', t:'act', label:'Fede llena la bañera', sub:'tapón + PrEP → "un baño"', deps:['plug','vase'],
    idea:'Cuando Fede te da la PrEP, se te va la paranoia: "Uf, qué alivio... ahora que estoy cubierto me merezco un baño de reina. Llename la bañera." Con el tapón (del ajedrez) puesto, arranca la secuencia de la bañera. (Adiós flor de la felicidad: la retiramos — nada de perder para ganar.)',
    todo:'GATILLO (vos, en vivo): al recibir la PrEP soltás la línea de alivio y pedís el baño. Vos manejás el timing.' },
