...
const NODES = [
  ...
  { id:'diarykey', x:0, y:2, c:'diary', t:'thing', label:'Llave del diario', sub:'para el candado del diario', deps:['a_decode'],
  ...
  { id:'vase', x:3, y:0, c:'tub', t:'thing', label:'Florero verde', sub:'esconde la PrEP',
    hide:'PrEP en un blister, dentro del florero',
    idea:'Estás paranoico y necesitás una pastilla PrEP "por las dudas". Está en un blister dentro del florero verde; Fede la encuentra ahí.',
    todo:'ARMÁS: blister de PrEP dentro del florero verde.' },
  { id:'a_getprep', x:3, y:1, c:'tub', t:'act', label:'Fede te da la PrEP', sub:'se te va la paranoia', deps:['vase'],
    idea:'Fede saca el blister de PrEP del florero verde y te lo da. Recién con la PrEP en la mano se te va la paranoia — pero no lo explicás.',
    todo:'RUNTIME: pasa en el juego cuando Fede saca la PrEP del florero.' },
  { id:'a_askfill', x:3, y:2, c:'tub', t:'act', label:'Pedís llenar la bañera', sub:'sin decir para qué', deps:['a_getprep'],
    idea:'Con la PrEP en la mano, le pedís a Fede que llene la bañera. NO decís que querés bañarte ni para qué — solo le pedís que la llene. El pedido no depende del tapón: vos pedís y Fede después se ocupa.',
    todo:'GATILLO (vos, en vivo): pedís que llene la bañera, sin explicar. Vos manejás el timing.' },
  { id:'a_filltub', x:3, y:3, c:'tub', t:'act', label:'Fede llena la bañera', sub:'busca el tapón si falta', deps:['a_askfill','plug'],
    idea:'Fede va a llenar la bañera. Si todavía no había encontrado el tapón (en el ajedrez), lo busca ahora — recién con el tapón puesto arranca la secuencia. (Adiós flor de la felicidad: la retiramos — nada de perder para ganar.)',
    todo:'RUNTIME: Fede llena la bañera; necesita el tapón (lo encuentra en este momento si no lo tenía).' },
  { id:'a_ducks', x:3, y:4, c:'tub', t:'act', label:'Aparecen los patos', sub:'anunciás la carrera', deps:['a_filltub'],
  ...
  { id:'code', x:3, y:5, c:'tub', t:'thing', label:'Código de patos', sub:'4-2-5-1-3', deps:['a_ducks','a_opendiary'],
  ...
  { id:'captcha', x:0, y:6, c:'hub', t:'thing', label:'Factor: captcha', sub:'REAL · identificar a Maxim',
  ...
  { id:'gym', x:1, y:6, c:'hub', t:'thing', label:'Factor: nombre', sub:'REAL · carnet John Greed',
  ...
  { id:'mirror', x:2, y:6, c:'hub', t:'thing', label:'Factor: contraseña', sub:'REAL · espejo empañado',
    idea:'Tu "sistema de seguridad infalible": la contraseña "380" en el espejo, invisible hasta que se empaña. La escribís EN VIVO con jabón (Dove) cuando te bañás durante la secuencia de la bañera; no está pre-escrita, aparece con el vapor.',
    todo:'LISTO: clave "380". EN VIVO: la escribís con jabón mientras te bañás (aparece con el vapor).' },
  { id:'f_phone', x:3, y:6, c:'hub', t:'act', label:'Factor: verificación telefónica', sub:'REAL · decís los patos', deps:['code'],
    ...
    todo:'LISTO Y CABLEADO: la llamada dicta "40719" y hay un factor en la app que pide ese código. Fede dispara la llamada él mismo (botón "Llamarme" en el banco, con fecha 21/11) + daemon en la laptop.' },
  // --- 10FA: los factores cómicos (fila 2) ---
  { id:'robot', x:4, y:6, c:'hub', t:'thing', label:'Factor: ¿es un robot?', sub:'cómico',
    idea:'Dropdown "¿Es usted un robot?". Solo "NO" pasa; "SÍ" y "PREFIERO NO DECIRLO" fallan.',
    todo:'LISTO.' },
  { id:'emotion', x:0, y:7, c:'hub', t:'thing', label:'Factor: emoción', sub:'cómico',
  ...
  { id:'hold', x:1, y:7, c:'hub', t:'thing', label:'Factor: compromiso', sub:'cómico',
    ...
    todo:'LISTO.' },
  { id:'party', x:6, y:6, c:'hub', t:'thing', label:'Factor: las partes', sub:'cómico · nombres',
  ...
  { id:'phoneslider', x:2, y:7, c:'hub', t:'thing', label:'Factor: teléfono del titular', sub:'cómico',
  ...
  { id:'tc', x:3, y:7, c:'hub', t:'thing', label:'Factor: T&C', sub:'cómico',
  ...
  { id:'heart', x:4, y:7, c:'hub', t:'thing', label:'Factor: firma', sub:'cómico',
    idea:'Dibujás un corazón roto en el recuadro para "certificar la operación".',
    todo:'LISTO.' },
  { id:'phonecode', x:5, y:7, c:'hub', t:'thing', label:'Factor: verificación telefónica', sub:'REAL · botón llamarme + código', deps:['f_phone'],
  ...
  { id:'tenfa', x:3, y:8, c:'hub', t:'thing', label:'10FA casi completo', sub:'falta el hígado',
  ...
  // --- clímax ---
  { id:'choice', x:5, y:9, c:'choice', t:'thing', label:'Inserte un hígado', sub:'LA elección', deps:['tenfa','liver'],
  ...
  { id:'final', x:5, y:10, c:'misc', t:'thing', label:'Mensaje final de Maxim', sub:'se transfiere', deps:['choice'],
  ...
  // --- flavor suelto (no gatilla nada) ---
  { id:'iou', x:0, y:9, c:'misc', t:'thing', label:'IOU de 400K', sub:'decorativo · flavor',
    hide:'sobre la mesa del TV',
    idea:'Un pagaré por USD 400.000 a nombre de Maxim, a la vista sobre la mesa del televisor. Fede lo encuentra suelto. Es puramente decorativo: da color a la cifra de la transferencia, pero no desbloquea ni depende de nada.',
    todo:'FÍSICO: dejá el IOU sobre la mesa del TV (decorativo).' },
];
